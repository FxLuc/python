...
Author: Le Tuan Luc
Date: 2021/07/03
Program: page_009_exercises_04.py
Problem:
...
Solution:
    ...
    A graphical user interface (GUI) organizes the monitor screen around the metaphor of a desktop, with windows containing icons for folders, files, and applications.
"""